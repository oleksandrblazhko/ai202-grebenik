    ...
    if (await create_order(
        {
            ...
            "count": "0",
            "date": "20.10.1994"
        }) == -3) console.log('TC1.4 (none; create_order(Grebenik Angelika Alexandrovna, 0, 20.10.1994)) == -3):  \nPassed');
    else console.log('TC1.4 (none; create_order(Grebenik Angelika Alexandrovna, 0, 20.10.1994)) == -3): \nFailed');
